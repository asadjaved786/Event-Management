        ...
        <div className="absolute right-0 bg-white rounded-md overflow-hidden shadow-lg z-10">
          <div className="">
            ...
            <div className="px-4 pb-2 cursor-default hover:bg-[color:var(--primary-color)]">
              <div className="text-gray-800 font-medium pt-2">Email</div>
            ...
            <div className="px-4 pb-2 cursor-default hover:bg-[color:var(--primary-color)]">
              ...
              <div className="text-gray-600">{userData.reg_number}</div>
            </div>
            <hr />
            <div className="px-4 pb-2 cursor-default hover:bg-[color:var(--primary-color)]">
              <div className="text-gray-800 font-medium pt-2">Member since</div>
