      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="relative h-40 sm:h-[25rem] overflow-hidden container shadow-lg">
          ...
          <Image
            ...
            fill
            // placeholder="blur"
            // blurDataURL={eventData?.profileImage}
        ...
        <div className="container bg-white py-4 mt-4 rounded-lg shadow-md">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between">
              ...
              {eventData?.price > totalPrice && !eventData?.isApproved ? (
                <div className="flex flex-col ">
                  <h3 className="text-xl font-semibold text-green-500 mb-2">
                    Just wait for admins response your request is under
                    consideration
                  </h3>
                </div>
              ) : (
              ...
              {eventData?.price < totalPrice && !eventData?.isApproved ? (
                ...
                >
                  <h3 className="text-xl font-semibold text-red-500 mb-2">
                    Request can not be accepted you must increase your budget to
                    ${totalPrice + 100}
                  </h3>
                </div>
              ) : (
              ...
              {eventData?.isApproved ? (
                <div className="flex flex-col ">
                  <h3 className="text-xl font-semibold text-green-500 mb-2">
                    Congrats your request have been accepted
                  </h3>
                </div>
              ) : (
                <div></div>
