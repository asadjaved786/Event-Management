          ...
          <div className="flex m-auto gap-4 lg:gap-8 overflow-y-hidden w-full h-[calc(88vh)]">
            ...
            <div className="flex w-full md:w-3/4 mx-auto justify-between container">
              <div className="p-4 overflow-y-auto w-full h-[calc(80vh)]">
                ...
                <button
                  onClick={() => router.push("/event/past")}
                  className="w-50 mt-2 text-white py-2 px-4 rounded-lg bg-gray-700 hover:bg-gray-800"
                >
                  Past events
                </button>
                        ...
                        >
                          ...
                          <div className="mt-4 flex justify-center ">
                            <button
                              ...
                              onClick={() => handleAccept(event.id)} // Replace with your accept function
                            >
                              Accept
                            </button>
                            <button
                              className="bg-slate-200 bg-slate-500 text-white font-bold py-2 px-5 rounded"
                              onClick={() => {
